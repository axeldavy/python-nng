...
_COMPETITOR_MODULES = [
    ...
    "benchmarks.competitors.nng_async7",
    ...
    "benchmarks.competitors.python_raw_sync",
    "benchmarks.competitors.python_raw_async",
]
...
def _import_competitors(requested: list[str]) -> None:
    ...
    for mod_path in _COMPETITOR_MODULES:
        ...
        name_map = {
            ...
            "nng_async7": "nng_async7",
            "zmq_sync": "zmq_sync",
            "zmq_async": "zmq_async",
            "pynng_sync": "pynng_sync",
            "pynng_async": "pynng_async",
            "c_nng_bench": "c_nng",
            "python_raw_sync": "python_raw_sync",
            "python_raw_async": "python_raw_async",
        }
